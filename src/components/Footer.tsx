      ...
      <div className="container mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            ...
            <p className="text-white/80 mb-4 max-w-md">
              RealSync provides innovative gateway solutions for connecting real-time simulators to remote hardware devices for efficient hardware-in-the-loop testing.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#features" className="text-white/80 hover:text-realsync-teal transition-colors">Features</a></li>
              <li><a href="#solutions" className="text-white/80 hover:text-realsync-teal transition-colors">Solutions</a></li>
              <li><a href="#about" className="text-white/80 hover:text-realsync-teal transition-colors">About</a></li>
              <li><a href="#contact" className="text-white/80 hover:text-realsync-teal transition-colors">Contact</a></li>
            </ul>
          </div>
        ...
        <div className="border-t border-white/10 mt-12 pt-8 text-center md:flex md:justify-between md:text-left">
          ...
          <div className="mt-4 md:mt-0 flex space-x-6 justify-center md:justify-start">
            <a href="#" className="text-white/70 hover:text-realsync-teal transition-colors">Privacy Policy</a>
